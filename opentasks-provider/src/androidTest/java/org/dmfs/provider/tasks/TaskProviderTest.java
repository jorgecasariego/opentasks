...
import static org.dmfs.android.contentpal.testing.PalOperationMatcher.resultsIn;
...
{
    private static final String ACC_NAME = "test-acc-name";
    private static final String ACC_TYPE = "test-acc-type";
    ...
    public void setUp() throws Exception
    {
        ...
        mAuthority = TaskAuthority.get(mContext);
    }
    ...
    public void testSingleInsert00() throws Exception
    {
        ...
        // TODO Use an InsertOperation here?
        ...
        assertThat(batch, resultsIn(mContext, mAuthority,
                new RowInserted(new TaskListsTable(mAuthority), TaskLists.LIST_NAME, "list 1"),
