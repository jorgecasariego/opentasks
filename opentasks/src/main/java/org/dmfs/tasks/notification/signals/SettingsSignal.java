...
public final class SettingsSignal implements NotificationSignal
{
    ...
    public int defaultsValue()
    {
        ...
        boolean sound = settings.getBoolean(mContext.getString(R.string.schedjoules_pref_notification_sound), true);
        boolean vibrate = settings.getBoolean(mContext.getString(R.string.schedjoules_pref_notification_vibrate), true);
        boolean lights = settings.getBoolean(mContext.getString(R.string.schedjoules_pref_notification_lights), true);
